...
class Pretty_TOC extends Base_Widget {
    public function __construct($data = [], $args = null) {
        parent::__construct($data, $args);

        wp_register_script( 'pretty-toc-elementor', PRETTY_TOC_PLUGIN_URI . 'src/index.js', array( 'jquery', 'elementor-frontend' ), '1.0.0', true );
    }

    public function get_script_depends() {
        return [ 'pretty-toc-elementor' ];
    }
    ...
    public function get_title() {
        return __( 'Pretty Table of Contents', 'elementor-pro' );
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			'update_url_hash',
			[
				'label' => __( 'Update url on item click', 'pretty-toc-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'duplicate_anchor_fix',
			[
				'label' => __( 'Duplicate anchor fix', 'pretty-toc-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'frontend_available' => true,
			]
    ...
    protected function render() {
        ...
        $this->add_render_attribute( '_wrapper', 'class', 'elementor-widget-table-of-contents' );
        ...
        <div class="elementor-toc__header">
            ...
            <div class="elementor-toc__toggle-button elementor-toc__toggle-button--expand"><?php Icons_Manager::render_icon( $settings['expand_icon'] ); ?>
            </div>
            <div class="elementor-toc__toggle-button elementor-toc__toggle-button--collapse"><?php Icons_Manager::render_icon( $settings['collapse_icon'] ); ?>
            </div>
            <?php endif; ?>
        </div>
